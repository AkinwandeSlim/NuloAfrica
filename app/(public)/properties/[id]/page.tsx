...
const propertyData = {
  ...
  fullAddress: "123 Riverside Drive, Westlands, Nairobi, Kenya",
  price: "$450,000",
  ...
  Featuring contemporary architecture with clean lines and expansive windows, this property maximizes natural light throughout. The open-plan living area seamlessly connects to a private garden, ideal for entertaining.

  The villa includes four spacious bedrooms, each with en-suite bathrooms and built-in wardrobes. The master suite features a walk-in closet and a luxurious bathroom with both a bathtub and rain shower.

  Located in one of Nairobi's most prestigious neighborhoods, you'll enjoy easy access to international schools, shopping centers, restaurants, and major business districts.`,
  amenities: [
    ...
    { icon: Home, label: "Private Garden" },
  ],
  features: [
    "Hardwood Floors",
    "Granite Countertops",
